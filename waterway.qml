...
<qgis version="2.18.6" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="full_id">
    ...
    <edittype widgetv2type="TextEdit" name="name_it">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="boat">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="alt_name">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="intermitte">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="arpav_codi">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="arpav_co_1">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="it_lombard">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="covered">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="motorboat">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="natural">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="whitewater">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{7d361ed0-a9b3-45c7-ab05-c1cd823007a0}">
      <rule filter="&quot;waterway&quot; in ('river','stream')" key="{9fceaa9b-104b-4b1d-8c1b-abf07cf4eb7b}" symbol="0" label="river">
        <rule filter="waterway='river'" key="{7975c2b9-0ea0-4724-b679-4c7f1d61ed77}" symbol="1" label="river"/>
        <rule filter="waterway&lt;>'river'" key="{681a8435-ad26-4d3f-8d67-8fb9e0a8a51e}" symbol="2" label="stream"/>
      </rule>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@0@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="width_dd_expression" v="length( segments_to_lines( $geometry))  * 1.2"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="1,111,255,255"/>
          <prop k="line_style" v="solid"/>
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="93,228,255,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.7899"/>
          <prop k="line_width_unit" v="MM"/>
  ...
  <displayfield>name_it</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="name_it" index="3" name=""/>
    <alias field="waterway" index="4" name=""/>
    <alias field="name" index="5" name=""/>
    <alias field="boat" index="6" name=""/>
    <alias field="name_de" index="7" name=""/>
    <alias field="operator" index="8" name=""/>
    <alias field="bridge" index="9" name=""/>
    <alias field="layer" index="10" name=""/>
    <alias field="tunnel" index="11" name=""/>
    <alias field="wikipedia" index="12" name=""/>
    <alias field="width" index="13" name=""/>
    <alias field="alt_name" index="14" name=""/>
    <alias field="intermitte" index="15" name=""/>
    <alias field="man_made" index="16" name=""/>
    <alias field="location" index="17" name=""/>
    <alias field="arpav_codi" index="18" name=""/>
    <alias field="arpav_co_1" index="19" name=""/>
    <alias field="it_lombard" index="20" name=""/>
    <alias field="covered" index="21" name=""/>
    <alias field="motorboat" index="22" name=""/>
    <alias field="natural" index="23" name=""/>
    <alias field="whitewater" index="24" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;waterway&quot;" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="name_it"/>
      <column width="-1" hidden="0" type="field" name="waterway"/>
      <column width="-1" hidden="0" type="field" name="name"/>
      <column width="-1" hidden="0" type="field" name="boat"/>
      ...
      <column width="-1" hidden="0" type="field" name="intermitte"/>
      <column width="-1" hidden="0" type="field" name="man_made"/>
      <column width="-1" hidden="0" type="field" name="location"/>
      <column width="-1" hidden="0" type="field" name="arpav_codi"/>
      <column width="-1" hidden="0" type="field" name="arpav_co_1"/>
      <column width="-1" hidden="0" type="field" name="it_lombard"/>
      <column width="-1" hidden="0" type="field" name="covered"/>
      <column width="-1" hidden="0" type="field" name="motorboat"/>
      <column width="-1" hidden="0" type="field" name="natural"/>
      <column width="-1" hidden="0" type="field" name="whitewater"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="alt_name" expression=""/>
    <default field="intermitte" expression=""/>
    <default field="man_made" expression=""/>
    <default field="location" expression=""/>
    <default field="arpav_codi" expression=""/>
    <default field="arpav_co_1" expression=""/>
    <default field="it_lombard" expression=""/>
    <default field="covered" expression=""/>
    <default field="motorboat" expression=""/>
    <default field="natural" expression=""/>
    <default field="whitewater" expression=""/>
  </defaults>
  <previewExpression>COALESCE( "name_it", '&lt;NULL>' )</previewExpression>
